...
classifier.addDocument(
  "Partager une voiture pour aller au travail réduit les émissions de gaz à effet de serre",
  "écologique"
);
classifier.addDocument(
  "Le covoiturage permet de réduire l'empreinte carbone de vos déplacements",
  "écologique"
);
classifier.addDocument(
  "Le covoiturage permet d'économiser de l'énergie et de l'argent",
  "écologique"
);
classifier.addDocument(
  "Le covoiturage réduit la congestion routière et améliore la qualité de l'air",
  "écologique"
);
classifier.addDocument(
  "Le covoiturage est une solution écologique pour les déplacements en ville",
  "écologique"
);
classifier.addDocument(
  "Le covoiturage permet de diminuer le nombre de voitures sur les routes",
  "écologique"
);
classifier.addDocument(
  "En choisissant le covoiturage, vous contribuez à la protection de l'environnement",
  "écologique"
);
classifier.addDocument(
  "Le covoiturage permet de limiter l'impact des déplacements sur l'environnement",
  "écologique"
);
classifier.addDocument(
  "Le covoiturage est une alternative écologique à la voiture individuelle",
  "écologique"
);
classifier.addDocument(
  "Le covoiturage permet de réduire les émissions de gaz à effet de serre et de préserver la qualité de l'air",
  "écologique"
);
classifier.addDocument(
...
classifier.addDocument("produit des déchets non-recyclables", "non-écologique");
...
classifier.addDocument("utilise des systèmes de recyclage d'eau", "écologique");
classifier.addDocument(
...
classifier.addDocument("encourage le covoiturage", "écologique");
classifier.addDocument(
...
classifier.addDocument("utilisation d'emballages biodégradables", "écologique");
...
classifier.addDocument("réduction de la consommation d'énergie", "écologique");
classifier.addDocument(
...
classifier.addDocument("utilisation de sachets en plastique", "non-écologique");
classifier.addDocument(
...
classifier.addDocument("utilise papier recyclé pour emballages", "écologique");
classifier.addDocument(
...
classifier.addDocument("produit non recyclable après usage", "non-écologique");
classifier.addDocument(
...
classifier.addDocument("emballage biodégradable et compostable", "écologique");
classifier.addDocument(
  "élimination des déchets respectueuse de l'environnement",
  "écologique"
);
classifier.addDocument("transports à faible émission de carbone", "écologique");
classifier.addDocument(
...
classifier.addDocument("pratique le recyclage et le compostage", "écologique");
classifier.addDocument(
...
classifier.addDocument("encourage la consommation de viande", "non-écologique");
classifier.addDocument(
  "utilise des produits chimiques toxiques",
  "non-écologique"
);
...
classifier.addDocument("recycle les déchets de manière efficace", "écologique");
classifier.addDocument(
...
classifier.addDocument("s'engage à réduire l'empreinte carbone", "écologique");
classifier.addDocument(
  "utilise des sachets en plastique pour emballer les produits",
  "non-écologique"
);
classifier.addDocument("n'utilise pas de matériaux recyclés", "non-écologique");
classifier.addDocument(
...
classifier.addDocument("utilise des sacs en toile réutilisables", "écologique");
classifier.addDocument(
...
classifier.addDocument("propose des articles en cuir animal", "non-écologique");
classifier.addDocument(
